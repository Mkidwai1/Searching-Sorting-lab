...
public class ConcertManager {
     ...
     * ascending. Letter case is ignored. Doesn't print or return anything.
     */
    ...
    public void sortByRowSeat() {
        Arrays.sort(concertTickets, new ConcertTicketRowAndSeatComparator());
    }
    /**
    ...
    private class ConcertTicketRowAndSeatComparator implements
            Comparator<ConcertTicket> {
        ...
        public int compare(ConcertTicket o1, ConcertTicket o2) {
            ...
            int compare = Character.compare(o1.getRow(), o2.getRow());
            
                if( 0 ==compare){
                return Integer.compare(o1.getSeat(), o2.getSeat());
                }
                else return compare;
        }
